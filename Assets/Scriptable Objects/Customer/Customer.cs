...
public class Customer : MonoBehaviour
{
    ...
    [SerializeField] CustomerModelsListSO _customerModelSO;
    ...
    private void LoadCharacterModel()
    {
        ...
        int randomModel = UnityEngine.Random.Range(0, _customerModelSO.ModelList.Count);
        Instantiate(_customerModelSO.ModelList[randomModel], this.transform);
    }
